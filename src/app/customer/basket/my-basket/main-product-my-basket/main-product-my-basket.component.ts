...
@Component({
  selector: 'app-main-product-my-basket',
  templateUrl: './main-product-my-basket.component.html',
  styleUrls: ['./main-product-my-basket.component.scss'],
})
export class MainProductMyBasketComponent extends ViewComponent implements OnInit {
