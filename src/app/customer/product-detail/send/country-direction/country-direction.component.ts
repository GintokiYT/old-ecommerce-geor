...
@Component({
  selector: 'app-country-direction',
  templateUrl: './country-direction.component.html',
  styleUrls: ['./country-direction.component.scss'],
})
export class CountryDirectionComponent extends ViewComponent implements OnInit {
  ...
  onGoToSend(parans?:any){
    if(parans){
      this.navigation.back("/customer/send",parans);
    }else{
      const p={
      countryName:this.countryName,
      countryFlag:this.countryFlag,
      }
      this.navigation.back("/customer/send",p);
    }
